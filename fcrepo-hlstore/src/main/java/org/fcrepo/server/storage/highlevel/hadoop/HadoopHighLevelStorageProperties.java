...
public class HadoopHighLevelStorageProperties {
	...
	public enum Column{
		LABEL,STATE,OWNER_ID,C_DATE,M_DATE,CONTENT_RAW;
		// TODO: HLS: add those
		// DCM_DATE,TITLE,CREATOR,SUBJECT,DESCRIPTION,PUBLISHER,CONTRIBUTER,TYPE,FORMAT,IDENTIFIER,SOURCE,LANGUAGE,RELATION,COVERAGE,RIGHTS;
